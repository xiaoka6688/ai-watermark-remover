...
**待办（下个会话做）**：
- [ ] **Phase 3 启动**（P3-01 SiteAdapter 基类）或 **打 v1.3.0 tag**
...
| 任务 | 状态 | 完成日期 | 备注 |
|---|---|---|---|
| P2-01 可灵 AI | 🟡 进行中 | 2026-07-01 | 基础框架完成；待登录研究 API |
| P2-02 Vidu | 🟢 已完成 | 2026-07-01 | feed/list API 拦截；media_asset + short_film；悬浮指示器 |
| P2-03 PixVerse | 🟢 已完成 | 2026-07-01 | showvideos + content/relation/list API；视频+图片下载 |
| P2-04 历史归档 | 🟢 已完成 | 2026-07-01 | formatFilename 归档目录；Options Page 可配前缀；31 个测试通过 |
| P2-05 批量下载会话 | 🟢 已完成 | 2026-07-01 | JSZip 打包；3 并发+进度；klingai/vidu/pixverse 统一实现 |
| P2-06 失败重试 | 🟢 已完成 | 2026-07-01 | fetchWithRetry 指数退避；klingai/vidu/pixverse 统一接入 |
| P2-07 暗色模式 | 🟢 已完成 | 2026-07-01 | CSS 变量 + prefers-color-scheme；Options Page 手动切换 |
| P2-08 Vite + TS 重构 | 🟡 进行中 | 2026-07-01 | 基础设施就绪；全量迁移待后续 |
| P2-09 ESLint + Prettier | 🟢 已完成 | 2026-07-01 | eslint.config.js + .prettierrc；npm run lint 通过 |
| P2-10 Playwright 测试 | 🟢 已完成 | 2026-07-01 | playwright.config.ts；3 个 e2e 测试 |
...
✅ **P2-10 Playwright 测试**（已完成 2026-07-01）

🎉 **Phase 2 全部完成！** 10/10 任务已完成。

### 下一个该做的

📌 **Phase 3 · 复刻阶段**：

- P3-01 SiteAdapter 基类（站点适配器抽象）
- P3-02 注册中心（URL 自动分发）
- P3-03 通用 UI 组件库
- P3-04 create-site CLI（一键生成新站模板）
- P3-05 manifest 自动注入
- P3-06 文档自动生成
- P3-07 官方模板市场

或打 **v1.3.0 tag** 发布 Phase 2 里程碑。
